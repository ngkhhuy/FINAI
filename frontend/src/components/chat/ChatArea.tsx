...
export function ChatArea({ messages, onFeedback, onSuggestionSelect, trackingParams = {} }: ChatAreaProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-thin bg-chat-surface">
