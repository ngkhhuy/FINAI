...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-border bg-card/90 backdrop-blur-md">
      <div className="max-w-2xl mx-auto px-3 sm:px-4 pt-3 pb-2">
        ...
        <div className="flex items-end gap-2 bg-background border border-border rounded-xl px-3 py-2 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none bg-transparent text-sm text-foreground placeholder:text-muted-foreground outline-none leading-relaxed py-0.5 max-h-[140px] scrollbar-thin"
            disabled={disabled}
          />
          <button
            onClick={handleSend}
